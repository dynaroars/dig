...
#include "stdlib.h"
void vtrace_else_24(int X , int Y , int k , int v , int rho , int xp , int y , int c ,
                    int p , int x ) 
{ 
...
void vtrace_if_24(int X , int Y , int k , int v , int rho , int xp , int y , int c ,
                  int p , int x ) 
{ 
...
void mainQ(int X , int Y , int k , int v , int rho ) 
{ 
  int xp ;
  int y ;
  int c ;
  ...
  x = 5;
  while (1) {
    if ((((((2 * Y) * xp - (2 * X) * y) - X) + 2 * Y) - v) + c <= k) {
      vtrace_if_24(X, Y, k, v, rho, xp, y, c, p, x);
    } else {
      vtrace_else_24(X, Y, k, v, rho, xp, y, c, p, x);
      break;
    }
    if (v < 0) {
      v += 2 * Y;
