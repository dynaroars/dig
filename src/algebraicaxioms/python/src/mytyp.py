# including functions to convert a variable to a java 'new' statement with randomly generated assignment
import random
import typing
...
class MyTyp:
    ...
    def reprname(cls, t):
        """
        >>> assert MyTyp.reprname(int) == 'int'

        >>> t1 = typing.List[typing.Any]
        >>> assert MyTyp.reprname(t1) == 'typing.List[typing.Any]'
        """
