...
> - [various examples](./EXAMPLES.md) demonstrating the power of DIG.
> - A good starting point to understand DIG and its usage at high level is reading our [ICSE'22 tool](https://dynaroars.github.io/pubs/nguyen2022syminfer.pdf) and [TSE'21](https://dynaroars.github.io/pubs/nguyen2021using.pdf) papers . 
> - [FAQs](#question-faqs) might be useful for researches, e.g., what makes DIG different than others?
