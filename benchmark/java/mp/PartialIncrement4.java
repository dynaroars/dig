public class PartialIncrement4 {
    public static void vtrace_loop1(
		int i, int p, int q, int r, int s, int t){}
    public static void vtrace_loop2(
		int i, int p, int q, int r, int s, int t){}
    public static void vtrace_loop3(
		int i, int p, int q, int r, int s, int t){}    
    public static void vtrace_loop4(
		int i, int p, int q, int r, int s, int t){} 
